...
public class LiveChatWithInvalidCredentials {

	//Variable Declartion
		private WebDriver driver;
		
		//Desc- LoginPage constructor
		public LiveChatWithInvalidCredentials(WebDriver driver) {
			this.driver = driver;
		}
		...
		public void submitButtonClick() {
			...
			submitBtn.click();
			 ...
			 File file = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			   try{
		            FileHandler.copy(file, new File("C:\\Users\\LENOVO\\eclipse-workspace\\LumensProject\\Screenshots\\LiveChatWithInvalisCred.png"));
